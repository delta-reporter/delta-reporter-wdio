...
describe('Basic validations', function() {
  ...
  xit('Should check that the page is loaded', () => {
  ...
  xit('Should check that the key presses page is loaded', () => {
  ...
  xit('Should check that the floating menu page is loaded', () => {
    browser.url('http://the-internet.herokuapp.com/floating_menu');
  });

  it.skip('Should check that the floating menu page is displayed', () => {
    browser.url('http://the-internet.herokuapp.com/floating_menu');
  });

  xit('Should check that the floating menu page is shown', () => {
    browser.url('http://the-internet.herokuapp.com/floating_menu');
  });
});
